...
class TodoController extends AbstractController
{
    ...
    public function complete(Todo $todo, EntityManagerInterface $entityManager): Response
    {
    ...
    #[Route('/delete/completed', name: 'app_todo_delete_completed', methods: ['GET'])]
    public function deleteCompleted(EntityManagerInterface $entityManager): Response
    {
